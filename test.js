...
describe('random scenarios', () => {
    describe('rewards distributed correctly after two distributions with multiple users joining at different times',()=>{
        ...
        const userADepositAge2 = (block8 - block4)*(amount1)
        const userBDepositAge2 = (block8 - block4)*(amount2)
        const userCDepositAge2 = (block5 - block4)*(amount3) + (block6 - block5)*(amount3 - amount5) + (block8 - block6)*(amount3 - amount5 + amount6)
